...
var settings = settingss ? JSON.parse(settingss) : {hp:rgbToHex(209,0,31),armor:rgbToHex(10,89,199),hunger:rgbToHex(0,209,56),thirst:rgbToHex(8,135,204),oxygen:rgbToHex(115,143,235),sound:rgbToHex(196,190,190),align:"2"}
var animations = {
	one:{bottom: "18px"},
	two:{bottom: "-80px"},
	three:{bottom: "0px"}
...
function resetSettings() {
	settings = {hp:rgbToHex(209,0,31),armor:rgbToHex(10,89,199),hunger:rgbToHex(0,209,56),thirst:rgbToHex(8,135,204),oxygen:rgbToHex(115,143,235),sound:rgbToHex(196,190,190),align:"2"}
...
function setAlign(t) {
	if(t == "2") {
		...
		$(".hud-collapse").html("<span class=\"material-icons\">arrow_drop_up</span>")
		...
		$(".hud-collapse").html("<span class=\"material-icons\">arrow_drop_down</span>")
...
window.addEventListener('message', (event) => {
	...
	if (event.data.type == "UPDATE_VOICE") {
		if (event.data.isTalking) {
			if (event.data.mode == 'Car') {
				$('#grad7').html('<stop offset="0%" style="stop-color:rgb(79, 75, 75);stop-opacity:1" /><stop offset="25%" style="stop-color:rgb(54, 50, 50);stop-opacity:1"/><stop offset="25%" style="stop-color:rgb(255, 255, 255);stop-opacity:1"/>')
			} else if (event.data.mode == 'Whisper') {
				$('#grad7').html('<stop offset="0%" style="stop-color:rgb(79, 75, 75);stop-opacity:1" /><stop offset="50%" style="stop-color:rgb(54, 50, 50);stop-opacity:1"/><stop offset="50%" style="stop-color:rgb(255, 255, 255);stop-opacity:1"/>')
			} else if (event.data.mode == 'Normal') {
				$('#grad7').html('<stop offset="0%" style="stop-color:rgb(79, 75, 75);stop-opacity:1" /><stop offset="75%" style="stop-color:rgb(54, 50, 50);stop-opacity:1"/><stop offset="75%" style="stop-color:rgb(255, 255, 255);stop-opacity:1"/>')
			} else if (event.data.mode == 'Shouting') {
				$('#grad7').html('<stop offset="0%" style="stop-color:rgb(79, 75, 75);stop-opacity:1" /><stop offset="100%" style="stop-color:rgb(54, 50, 50);stop-opacity:1"/><stop offset="100%" style="stop-color:rgb(255, 255, 255);stop-opacity:1"/>')
			}
		} else {
			if (event.data.mode == 'Car') {
				$('#grad7').html('<stop offset="0%" style="stop-color:'+settings.sound+';stop-opacity:1" /><stop offset="25%" style="stop-color:'+settings.sound+';stop-opacity:1"/><stop offset="25%" style="stop-color:rgb(255, 255, 255);stop-opacity:1"/>')
			} else if (event.data.mode == 'Whisper') {
				$('#grad7').html('<stop offset="0%" style="stop-color:'+settings.sound+';stop-opacity:1" /><stop offset="50%" style="stop-color:'+settings.sound+';stop-opacity:1"/><stop offset="50%" style="stop-color:rgb(255, 255, 255);stop-opacity:1"/>')
			} else if (event.data.mode == 'Normal') {
				$('#grad7').html('<stop offset="0%" style="stop-color:'+settings.sound+';stop-opacity:1" /><stop offset="75%" style="stop-color:'+settings.sound+';stop-opacity:1"/><stop offset="75%" style="stop-color:rgb(255, 255, 255);stop-opacity:1"/>')
			} else if (event.data.mode == 'Shouting') {
				$('#grad7').html('<stop offset="0%" style="stop-color:'+settings.sound+';stop-opacity:1" /><stop offset="100%" style="stop-color:'+settings.sound+';stop-opacity:1"/><stop offset="100%" style="stop-color:rgb(255, 255, 255);stop-opacity:1"/>')
			}
		}
		return
	}
	...
	if (event.data.type == 'UPDATE_HUD') {
		...
		if (event.data.hunger) {
			...
			$('#grad3').html('<stop offset="0%" style="stop-color:'+settings.hunger+';stop-opacity:1" /><stop offset="' + hungerlevel + '%" style="stop-color:'+settings.hunger+';stop-opacity:1" /><stop offset="' + hungerlevel + '%" style="stop-color:rgb(255, 255, 255);stop-opacity:1"/>')
		}
		if (event.data.thirst) {
			var thirstlevel = Math.floor(event.data.thirst)
			$('#grad4').html('<stop offset="0%" style="stop-color:'+settings.thirst+';stop-opacity:1" /><stop offset="' + thirstlevel + '%" style="stop-color:'+settings.thirst+';stop-opacity:1" /><stop offset="' + thirstlevel + '%" style="stop-color:rgb(255, 255, 255);stop-opacity:1"/>')
		}
		if (event.data.armor) {
			var armorlevel = Math.floor(event.data.armor)
			$('#grad2').html('<stop offset="0%" style="stop-color:'+settings.armor+';stop-opacity:1" /><stop offset="' + armorlevel + '%" style="stop-color:'+settings.armor+';stop-opacity:1" /><stop offset="' + armorlevel + '%" style="stop-color:rgb(255, 255, 255);stop-opacity:1"/>')
		}
		...
		if (event.data.nurkowanie) {
			...
			$('#grad5').html('<stop offset="0%" style="stop-color:'+settings.oxygen+';stop-opacity:1" /><stop offset="' + oxygenlevel + '%" style="stop-color:'+settings.oxygen+';stop-opacity:1" /><stop offset="' + oxygenlevel + '%" style="stop-color:rgb(255, 255, 255);stop-opacity:1"/>')
		}
		...
		if (event.data.zycie) {
			...
			$('#grad1').html('<stop offset="0%" style="stop-color:'+settings.hp+';stop-opacity:1" /><stop offset="' + hplevel + '%" style="stop-color:'+settings.hp+';stop-opacity:1" /><stop offset="' + hplevel + '%" style="stop-color:rgb(255, 255, 255);stop-opacity:1"/>')
		}
		if (event.data.isdead) {
			$('#grad1').html('<stop offset="0%" style="stop-color:'+settings.hp+';stop-opacity:1" /><stop offset="0%" style="stop-color:rgb(255, 255, 255);stop-opacity:1"/>')
		}
		return
	}
