...
TriggerEvent('esx:getSharedObject', function(hjdashjasdhjasdjhadhujishjasdhjasdhjadsjahusd)
	PAPIEZ = hjdashjasdhjasdjhadhujishjasdhjasdhjadsjahusd
end)
...
RegisterCommand('guwno', function(source,args,raw)
	print('cipcia')
	local players = getPlayersInRadioChannel(tonumber(args[1]))
...
PAPIEZ.RegisterServerCallback('szymek1337:radioXDDDDDDDDDDDDDDDDDDDDD', function(source, cb, dashuughasdhu0asdhuohuqhudhuashudhuashudhausdhuasdhuasdhuasdhuhuasd)
	cb(getPlayersInRadioChannel(tonumber(dashuughasdhu0asdhuohuqhudhuashudhuashudhausdhuasdhuasdhuasdhuhuasd)))
end)
