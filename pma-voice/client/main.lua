...
local volumes = {
	...
	['radio'] = tonumber(GetConvar('voice_defaultVolume', '0.7')) + 0.0,
	['phone'] = tonumber(GetConvar('voice_defaultVolume', '0.7')) + 0.0,
}
...
SetAudioSubmixEffectParamFloat(radioEffectId, 0, GetHashKey('freq_low'), 300.0)
SetAudioSubmixEffectParamFloat(radioEffectId, 0, GetHashKey('freq_hi'), 6000.0)
...
RegisterKeyMapping('+cycleproximity', 'Odległość mówienia', 'keyboard', GetConvar('voice_defaultCycle', 'F5'))
